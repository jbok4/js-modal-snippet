Below is the JavaScript challenge. There is no timeline on completion, though the sooner you complete it the sooner we can review it. Please let me know if you have any questions.
